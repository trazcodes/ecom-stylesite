...
function MenProducts() {
    ...
    const getAllProducts = async () => {
        try {
            ...
            setProducts(resp.data.products.filter(p => p.category.mainCategory === 'men'));
        } catch (error) {
    ...
    const getAllCategory = async () => {
        try {
            ...
            setCategories(resp.data?.category.filter(c => c.mainCategory === 'men'));
        } catch (error) {
    ...
    const applyProductFilter = async (checkedCategories, priceRange) => {
        try {
            const filteredProducts = await productFilter(checkedCategories, priceRange, 'men');
